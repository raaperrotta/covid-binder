...
def ode(initial_exposed, initial_infectious, beta, beta_detected_ratio, sigma, theta,
        gamma_mu, gamma_detected, mu_detected):
...
def transform(initial_exposed, initial_infectious, beta, beta_detected_ratio, sigma, theta, gamma_mu, gamma_detected, mu_detected):
    ...
    return initial_exposed, initial_infectious, beta, beta_detected_ratio, sigma, theta, gamma_mu, gamma_detected, mu_detected


def func(initial_exposed, initial_infectious, beta, beta_detected_ratio, sigma, theta, gamma_mu, gamma_detected, mu_detected):
    return calc_score(
        *ode(
            *transform(
                initial_exposed, initial_infectious, beta, beta_detected_ratio, sigma, theta, gamma_mu, gamma_detected, mu_detected
            )
        )
    )
...
def main():
    ...
    kwargs, best_kwargs = util.fit_nevergrad_model(
        instrum, 2_000_000, ng.optimizers.TwoPointsDE, func, num_workers=48, num_processes=6, save_after=1_000
    )
    print('Recommendation:', func(**kwargs))
    print('Best scorer:', func(**best_kwargs))

    # initial_exposed, initial_infectious, beta, beta_detected_ratio, sigma, theta, gamma_mu, gamma_detected, mu_detected = transform(**recommendation.kwargs)
    # exposed, infectious, detected, recovered, dead = ode(initial_exposed, initial_infectious, beta,
    #                                                      beta_detected_ratio, sigma,
    #                                                      theta, gamma_mu, gamma_detected, mu_detected)
